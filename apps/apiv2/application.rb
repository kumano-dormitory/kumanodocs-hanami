...
module Apiv2
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['APIV2_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Apiv2::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Apiv2::Action is included
