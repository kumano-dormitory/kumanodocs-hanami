...
describe Web::Controllers::Gijiroku::Edit do
  describe 'when user is logged in' do
    ...
    it 'is successful' do
      ...
      action = Web::Controllers::Gijiroku::Edit.new(gijiroku_repo: gijiroku_repo, authenticator: authenticator)
  ...
  describe 'when user is not logged in' do
    ...
    let(:action) { Web::Controllers::Gijiroku::Edit.new(gijiroku_repo: nil, authenticator: authenticator) }
